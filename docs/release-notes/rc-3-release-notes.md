...
See [ADR-004: Explicit Sink Routing](../design/adr/004-adr-explicit-sink-routing.md) for the full rationale.
...
Connection names and sink names occupy separate namespaces. A collision between the two is a `GraphValidationError`. See [ADR-005: Declarative DAG Wiring](../design/adr/005-adr-declarative-dag-wiring.md).
...
| ADR | Title | Status |
|-----|-------|--------|
| [ADR-004](../design/adr/004-adr-explicit-sink-routing.md) | Explicit Sink Routing | Approved, Implemented |
| [ADR-005](../design/adr/005-adr-declarative-dag-wiring.md) | Declarative DAG Wiring | Approved, Implemented |
