...
- **Suite reporting outputs** – `SuiteReportGenerator` consolidates suite payloads, writes consolidated/visual/Excel artifacts, and surfaces analytics-ready summaries for accreditation reviewers (`src/elspeth/tools/reporting.py:19`, `src/elspeth/cli.py:392`, `src/elspeth/plugins/outputs/visual_report.py:11`, `src/elspeth/plugins/outputs/analytics_report.py:11`, `src/elspeth/plugins/outputs/excel.py:19`).[^diagram-suite-2025-10-12]
