...
Update 2025-10-12: Datasource implementations reside under `src/elspeth/plugins/nodes/sources/` (e.g., `csv_local.py`, `csv_blob.py`, `blob.py`) following the nodes/sources/sinks reorganisation.
<!-- END UPDATE -->
...
Update 2025-10-12: Baseline and early-stop factories are surfaced at `src/elspeth/core/experiments/plugin_registry.py:166-188` with normalisation helpers in `src/elspeth/core/experiments/plugin_registry.py:418-454`.
<!-- END UPDATE -->
...
Update 2025-10-12: LLM middleware modules moved to `src/elspeth/plugins/nodes/transforms/llm/middleware*.py`; functional coverage and hook signatures remain as documented.
<!-- END UPDATE -->
...
Update 2025-10-12: Sanitisation and signing sinks now live under `src/elspeth/plugins/nodes/sinks/` (`csv_file.py`, `_sanitize.py`, `signed.py`); behaviour validated against current implementations.
<!-- END UPDATE -->
...
<!-- UPDATE 2025-10-12: Baseline comparison line references -->
Update 2025-10-12: Variant comparison logic executes at `src/elspeth/core/experiments/suite_runner.py:360-382`, with registry-backed plugin instantiation at `src/elspeth/core/experiments/plugin_registry.py:166-188`.
<!-- END UPDATE -->
...
Update 2025-10-12: Analytics sink implementation is located at `src/elspeth/plugins/nodes/sinks/analytics_report.py:16-133` with unchanged output schema.
<!-- END UPDATE -->
...
Update 2025-10-12: Visual analytics sink resides at `src/elspeth/plugins/nodes/sinks/visual_report.py:17-199`; enhanced variants live in `src/elspeth/plugins/nodes/sinks/enhanced_visual_report.py` when optional extras are enabled.
<!-- END UPDATE -->
...
<!-- UPDATE 2025-10-12: CLI dispatch line update -->
Update 2025-10-12: Suite report generation is invoked at `src/elspeth/cli.py:395-458` after suite execution completes.
<!-- END UPDATE -->
...
<!-- UPDATE 2025-10-12: Visual artefact path alignment -->
Update 2025-10-12: Evidence generation and metadata embedding confirmed at `src/elspeth/plugins/nodes/sinks/visual_report.py:115-199` and `enhanced_visual_report.py:120-228`.
<!-- END UPDATE -->
...
<!-- UPDATE 2025-10-12: Credential accessor paths -->
Update 2025-10-12: Environment-based credential resolution occurs in `src/elspeth/plugins/nodes/sinks/blob.py:248-275`, `repository.py:140-219`, and `signed.py:108-123`.
<!-- END UPDATE -->
...
<!-- UPDATE 2025-10-12: Outbound call path alignment -->
Update 2025-10-12: Azure Content Safety HTTP interactions are implemented at `src/elspeth/plugins/nodes/transforms/llm/middleware.py:297-320`; repository uploads use `src/elspeth/plugins/nodes/sinks/repository.py:139-213`.
<!-- END UPDATE -->
...
[^sanitisation-2025-10-12]: Update 2025-10-12: Sanitisation controls cross-referenced in docs/architecture/security-controls.md (Update 2025-10-12: Output Sanitisation) and docs/compliance/CONTROL_INVENTORY.md (Update 2025-10-12: Sanitisation Controls).
...
[^cost-2025-10-12]: Update 2025-10-12: Cost propagation linked to docs/development/dependency-analysis.md (Update 2025-10-12: Cost Tracker Dependencies).
...
[^visual-2025-10-12]: Update 2025-10-12: Visual sink artefacts referenced in docs/examples/colour-animals.md (Update 2025-10-12: Visual Analytics Usage).
