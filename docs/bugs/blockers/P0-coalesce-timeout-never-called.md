...
- [ ] `check_timeouts()` called periodically in processor main loop
- [ ] `best_effort` policy fires at configured timeout
- [ ] Timed-out branches recorded in audit trail
- [ ] Integration test with deliberate branch delay
