...
- Goal or task prompt: You are a static analysis agent doing a deep bug audit. Target file: /home/john/elspeth-rapid/src/elspeth/core/rate_limit/__init__.py
...
- `src/elspeth/core/rate_limit/__init__.py:1` shows only module docstring and re-exports; no logic to analyze for the specified bug categories.
