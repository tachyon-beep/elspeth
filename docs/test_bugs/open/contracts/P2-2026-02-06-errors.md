# Test Bug Report: Fix weak assertions in errors
...
- Date: 2026-02-06
- Audit file: docs/test_audit/tests_contracts_test_errors.py.audit.md

## Test File

- **File:** `tests/contracts/test_errors.py`
- **Lines:** 646
- **Test count:** 44
...
- Run after fix: `.venv/bin/python -m pytest tests/contracts/test_errors.py -v`

## Notes

- Source audit: `docs/test_audit/tests_contracts_test_errors.py.audit.md`
