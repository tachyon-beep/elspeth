...
FROM python:3.12.12-slim@sha256:408ad54fa40b7a4fff7cb21ce6e1b74eb5154bfc6c0fbd0af98560c1850db88f AS base
ARG PYTHON_IMAGE
...
# Install build dependencies from hash-locked file (needed for --no-build-isolation)
