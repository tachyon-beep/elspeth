# tests_v2/unit/contracts/transform_contracts/test_batch_transform_protocol.py
...
from tests_v2.fixtures.factories import make_contract, make_pipeline_row, make_row
