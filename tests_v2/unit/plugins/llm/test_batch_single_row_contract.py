...
class TestAzureBatchSingleRowContractPropagation:
    ...
    def input_contract(self) -> SchemaContract:
        ...
        return SchemaContract(
            mode="FLEXIBLE",
            fields=(make_field("customer_id", str, original_name="customer_id", required=True, source="declared"),),
            locked=True,
        )
    ...
    def output_contract(self) -> SchemaContract:
        ...
        return SchemaContract(
            ...
            fields=(
                ...
                make_field("llm_response", str, original_name="llm_response", required=True, source="inferred"),
            ),
            locked=True,
        )
    ...
    def test_process_single_preserves_contract_from_batch_result(
        ...
        # Input row
        input_row = make_row({"customer_id": "C001", "text": "hello"}, contract=input_contract)
        ...
        batch_result = TransformResult.success_multi(
            [make_row(batch_output_row, contract=output_contract)],
