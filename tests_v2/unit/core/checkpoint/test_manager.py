...
from tests_v2.fixtures.factories import make_graph_linear
...
def test_validate_checkpoint_compatibility_rejects_mismatched_version(
    checkpoint_manager: CheckpointManager, version: int
) -> None:
    checkpoint = Checkpoint(
        checkpoint_id="cp-test",
        run_id="run-001",
