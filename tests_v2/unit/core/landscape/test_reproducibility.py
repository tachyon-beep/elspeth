...
class TestComputeGrade:
    ...
    def test_seeded_returns_full(self) -> None:
        db, recorder = _setup()
        recorder.register_node(
            run_id="run-1", plugin_name="sampler", node_type=NodeType.TRANSFORM,
            plugin_version="1.0", config={}, node_id="n1", schema_config=_DYNAMIC_SCHEMA,
    ...
    def test_nondeterministic_returns_replay(self) -> None:
        db, recorder = _setup()
        recorder.register_node(
            run_id="run-1", plugin_name="llm", node_type=NodeType.TRANSFORM,
            plugin_version="1.0", config={}, node_id="n1", schema_config=_DYNAMIC_SCHEMA,
    ...
    def test_external_call_returns_replay(self) -> None:
        db, recorder = _setup()
        recorder.register_node(
            run_id="run-1", plugin_name="api", node_type=NodeType.TRANSFORM,
            plugin_version="1.0", config={}, node_id="n1", schema_config=_DYNAMIC_SCHEMA,
    ...
    def test_io_read_returns_replay(self) -> None:
        db, recorder = _setup()
        recorder.register_node(
            run_id="run-1", plugin_name="reader", node_type=NodeType.SOURCE,
            plugin_version="1.0", config={}, node_id="n1", schema_config=_DYNAMIC_SCHEMA,
    ...
    def test_io_write_returns_replay(self) -> None:
        db, recorder = _setup()
        recorder.register_node(
            run_id="run-1", plugin_name="writer", node_type=NodeType.SINK,
            plugin_version="1.0", config={}, node_id="n1", schema_config=_DYNAMIC_SCHEMA,
    ...
    def test_mixed_deterministic_and_nondeterministic(self) -> None:
        ...
        recorder.register_node(
            run_id="run-1", plugin_name="llm", node_type=NodeType.TRANSFORM,
            plugin_version="1.0", config={}, node_id="n2", schema_config=_DYNAMIC_SCHEMA,
            determinism=Determinism.NON_DETERMINISTIC,
        )
        grade = compute_grade(db, "run-1")
        assert grade == ReproducibilityGrade.REPLAY_REPRODUCIBLE
