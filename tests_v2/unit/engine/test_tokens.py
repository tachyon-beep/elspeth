# tests_v2/unit/engine/test_tokens.py
...
from tests_v2.unit.engine.conftest import DYNAMIC_SCHEMA


def _make_observed_contract(*field_names: str) -> SchemaContract:
    """Create an OBSERVED mode contract with specified fields."""
    fields = tuple(
        make_field(name=name, original_name=f"'{name}'", python_type=object, required=False, source="inferred")
