# tests_v2/unit/engine/test_batch_token_identity.py
...
from tests_v2.unit.engine.conftest import DYNAMIC_SCHEMA, _TestSchema
    ...
    with recorder._db.connection() as conn:
        ...
        for member in members:
            ...
            outcome_row = conn.execute(
                select(token_outcomes_table.c.outcome).where(token_outcomes_table.c.token_id == token_id)
            ).fetchone()
