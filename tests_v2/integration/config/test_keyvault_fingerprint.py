# tests_v2/integration/config/test_keyvault_fingerprint.py
...
Skip by default; run with: pytest -m integration tests_v2/integration/config/test_keyvault_fingerprint.py
...
4. Run with the Key Vault URL:
   pytest -m integration tests_v2/integration/config/test_keyvault_fingerprint.py \
...
Migrated from tests/integration/test_keyvault_fingerprint.py
"""
...
# Fixture keyvault_url is provided by tests_v2/integration/conftest.py
