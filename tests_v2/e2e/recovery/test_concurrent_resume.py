...
class TestConcurrentResume:
    ...
    def test_second_resume_of_completed_run_rejected(
        self, tmp_path: Path
    ) -> None:
        ...
        _source_for_graph, _transforms, _sinks, graph = build_linear_pipeline(
            source_data
        )
    ...
    def test_resume_of_non_existent_run_rejected(
        self, tmp_path: Path
    ) -> None:
