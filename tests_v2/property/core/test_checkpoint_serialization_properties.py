# tests_v2/property/core/test_checkpoint_serialization_properties.py
...
from tests_v2.strategies.json import json_primitives, json_values
...
class TestTypeTagIsolation:
    ...
    def test_nested_datetime_tags_restored(self) -> None:
        ...
        data = {
            "outer": {
                "__datetime__": "2024-01-01T00:00:00+00:00"
            },
            "list": [
