...
def _make_contract(fields: tuple[FieldContract, ...] | None = None) -> SchemaContract:
...
class TestCoalesceExecutorPipelineRow:
    ...
    def test_coalesce_merges_contracts(self) -> None:
        ...
        contract_a = _make_contract(
            fields=(
                ...
                FieldContract(
                    normalized_name="branch_a_field",
        ...
        contract_b = _make_contract(
            fields=(
                ...
                FieldContract(
                    normalized_name="branch_b_field",
        ...
        token_a = TokenInfo(
            row_id="row_001",
            token_id="token_a",
            row_data=PipelineRow({"amount": 100, "branch_a_field": "a"}, contract_a),
        ...
        token_b = TokenInfo(
            row_id="row_001",
            token_id="token_b",
            row_data=PipelineRow({"amount": 100, "branch_b_field": "b"}, contract_b),
    ...
    def test_coalesce_merge_failure_raises_orchestration_error(self) -> None:
        ...
        token_a = TokenInfo(
            row_id="row_001",
            token_id="token_a",
            row_data=PipelineRow({"value": 100}, contract_a),
            branch_name="branch_a",
            fork_group_id="fork_001",
        )
        token_b = TokenInfo(
            row_id="row_001",
            token_id="token_b",
            row_data=PipelineRow({"value": "text"}, contract_b),
            branch_name="branch_b",
            fork_group_id="fork_001",
        )
    ...
    def test_coalesce_preserves_row_data_correctly(self) -> None:
        ...
        token_a = TokenInfo(
            row_id="row_001",
            token_id="token_a",
            row_data=PipelineRow({"amount": 100, "a_only": "a"}, contract),
            branch_name="branch_a",
            fork_group_id="fork_001",
        )
        token_b = TokenInfo(
            row_id="row_001",
            token_id="token_b",
            row_data=PipelineRow({"amount": 200, "b_only": "b"}, contract),
            branch_name="branch_b",
            fork_group_id="fork_001",
        )
