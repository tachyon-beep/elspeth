# tests/integration/test_resume_comprehensive.py
...
class TestResumeComprehensive:
            ...
            for node_id, plugin_name, node_type in [
                ...
                conn.execute(
                    nodes_table.insert().values(
                        ...
                        determinism="deterministic" if node_type != "sink" else "io_write",
                        config_hash="test",
                        config_json="{}",
                        registered_at=now,
                    )
    ...
    def test_resume_normal_path_with_remaining_rows(
        ...
        resume_graph._sink_id_map = {"default": "sink"}
        resume_graph._transform_id_map = {0: "xform"}
        resume_graph._output_sink = "default"
