...
class TestFieldExtractionReportsBothNames:
    ...
    def test_field_extraction_reports_both_names(self) -> None:
        ...
        With a contract, extraction should resolve original names to normalized
        and report both forms along with resolution success.
        """
        contract = SchemaContract(
            mode="OBSERVED",
            fields=(
    ...
    def test_field_extraction_without_contract(self) -> None:
        ...
        Without a contract, extraction reports the name as-is with resolved=False.
        """
...
class TestComplexTemplateWithConditionals:
    ...
    def test_complex_template_with_conditionals(self) -> None:
        ...
        Tests that templates with if/else, multiple fields, and mixed
        access patterns render correctly.
        """
        contract = SchemaContract(
            mode="OBSERVED",
            fields=(
