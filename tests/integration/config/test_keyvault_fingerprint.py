# tests/integration/config/test_keyvault_fingerprint.py
...
Skip by default; run with: pytest -m integration tests/integration/config/test_keyvault_fingerprint.py
...
4. Run with the Key Vault URL:
   pytest -m integration tests/integration/config/test_keyvault_fingerprint.py \
