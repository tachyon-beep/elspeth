...
class TestOpenRouterLLMStress:
    ...
    # NOTE: test_fifo_ordering_preserved removed to reduce CI stress test runtime.
    # FIFO ordering is validated implicitly by other tests and the BatchTransformMixin
    # unit tests. The stress version added ~2-3 minutes with 100 rows + stress_aimd preset.
