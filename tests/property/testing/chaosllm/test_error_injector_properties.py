# tests/property/testing/chaosllm/test_error_injector_properties.py
...
class TestSelectionModes:
    ...
    def test_priority_mode_connection_first(self, seed: int) -> None:
        ...
        for _ in range(100):
            d = injector.decide()
            assert d.error_type == "connection_failed", f"Priority mode: connection_failed should win over rate_limit, got {d.error_type}"
