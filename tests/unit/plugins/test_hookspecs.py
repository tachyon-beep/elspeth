...
class TestHookspecs:
    ...
    def test_hookspec_marker_exists(self) -> None:
        from elspeth.plugins.infrastructure.hookspecs import hookspec
    ...
    def test_source_hooks_defined(self) -> None:
        from elspeth.plugins.infrastructure.hookspecs import ElspethSourceSpec
    ...
    def test_transform_hooks_defined(self) -> None:
        from elspeth.plugins.infrastructure.hookspecs import ElspethTransformSpec

        assert hasattr(ElspethTransformSpec, "elspeth_get_transforms")

    def test_sink_hooks_defined(self) -> None:
        from elspeth.plugins.infrastructure.hookspecs import ElspethSinkSpec
